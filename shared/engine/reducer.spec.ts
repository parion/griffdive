...
import { allDiversPicked, canRerollWheel, comboKey, diverCeiling, diverLuck, diverOptions, pactOfferFor, pactRiskOf, rewardPoolFor, teamRiskOf } from './selectors'
...
describe('identity actions', () => {
  ...
  it('TRANSFER_HOST moves host flags', () => {
    const withTwo: DiveState = {
      ...freshState(),
      divers: [
        { id: 'p1', name: 'A', isHost: true, pactsLocked: false, pactIds: [], failedPactIds: [], pickedOptionId: null, warbondCodes: [] },
        { id: 'p2', name: 'B', isHost: false, pactsLocked: false, pactIds: [], failedPactIds: [], pickedOptionId: null, warbondCodes: [] },
      ],
    }
